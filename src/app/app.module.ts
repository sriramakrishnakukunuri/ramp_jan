...
@NgModule({
    ...
    declarations: [
        ...
        GetOutcomeComponent,
        ViewMsmeCouncellorDataComponent, ProgramSessionsComponent, AllParticipantsVerificationComponent, AttentanceParticipantComponent, VerificationParticipantComponent,
    ],
    providers: [
