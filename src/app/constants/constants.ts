...
export const APIS = {
  ...
  participantdata: {
    ...
    getParticipantNonTrainingbyOrgainizationId: API_BASE_URL + '/participants/search-by-organization/',
  },
  counsellerData: {
  ...
  masterList: {
    ...
    getOrganizationByOrgId: API_BASE_URL + '/organization',
    updateOrganization: API_BASE_URL + '/update/',
  },
  trainingtargets: {
  ...
  nontrainingtargets: {
    ...
    getTgtpcNtReports: API_BASE_URL +'/tgtpc-nt-reports/get-by-sub-activity/',
    deleteTgtpcNtReports: API_BASE_URL +'/tgtpc-nt-reports/delete/',
...
tgtpc10: {
  ...
  getHandholdingBySubActivity: API_BASE_URL + '/tgtpc-handholding/get'
    ...
    citd: {
      saveVisitDetails: API_BASE_URL + '/visit-details/save',
      updateVisitDetails: API_BASE_URL + '/visit-details/update/',
  ...
  msmeQueaterly: {
    ...
    getMSMEByQuarterIntervention: API_BASE_URL + '/momsme/report/by-quarter/intervention',
