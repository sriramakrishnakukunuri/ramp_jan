...
@Component({
  selector: 'app-non-training-tgtpc4',
  templateUrl: './non-training-tgtpc4.component.html',
  styleUrls: ['./non-training-tgtpc4.component.css']
})
export class NonTrainingTgtpc4Component implements OnInit {
