...
@Component({
  selector: 'app-non-training-coi',
  templateUrl: './non-training-coi.component.html',
  styleUrls: ['./non-training-coi.component.css']
})
export class NonTrainingCoiComponent implements OnInit {
