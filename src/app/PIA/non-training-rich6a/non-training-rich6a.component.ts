...
@Component({
  selector: 'app-non-training-rich6a',
  templateUrl: './non-training-rich6a.component.html',
  styleUrls: ['./non-training-rich6a.component.css']
})
export class NonTrainingRich6aComponent implements OnInit {
