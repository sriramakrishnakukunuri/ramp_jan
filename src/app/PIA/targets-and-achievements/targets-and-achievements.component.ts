...
@Component({
  selector: 'app-targets-and-achievements',
  templateUrl: './targets-and-achievements.component.html',
  styleUrls: ['./targets-and-achievements.component.css']
})
export class TargetsAndAchievementsComponent implements OnInit {
