...
@Component({
  selector: 'app-non-training-tgtpc10',
  templateUrl: './non-training-tgtpc10.component.html',
  styleUrls: ['./non-training-tgtpc10.component.css']
})
export class NonTrainingTgtpc10Component implements OnInit {
