  ...
  initializeForm(): void {
    this.diagnosticForm = this.fb.group({
      ...
      operationalStatus: this.fb.group({
        skilledCount: [0, [Validators.required, Validators.min(0)]],
        unskilledCount: [0, [Validators.required, Validators.min(0)]],
        femaleCount: [0, [Validators.required, Validators.min(0)]],
        installedCapacity: [0, [Validators.required, Validators.min(0), Validators.max(100)]],
        utilizedCapacity: [0, [Validators.required, Validators.min(0), Validators.max(100)]],
        observation: ['', Validators.required],
        isWorking: [true],
        hasUnsecuredLoans: [false],
        requiredLoanAmount: [0, [Validators.required, Validators.min(0)]],
        loanSecurityType: ['', Validators.required],
