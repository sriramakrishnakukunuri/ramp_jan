...
managrData:any
  ...
  initializeForm() {
    this.sanctionForm = this.fb.group({
      ...
      roi: [null, [Validators.required, Validators.min(1), Validators.max(100)]],
      ...
      isSecurityProvided: [null, Validators.required],
      securityDescription: [''],
      productType: [''],
      securityType: [''],
      securityValue: [0],
